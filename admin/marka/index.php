    ...
    <table>
      ...
      do {
        echo '
              ...
              <td>' . $row['email'] . '</td>
              <td>' . $row['id_access'] . '</td>
              <td><a href="action\show.php?id=' . $row['id_user'] . '">Перегляд</a></td>
              <td><a href="action\edit.php?id=' . $row['id_user'] . '">Оновити</a></td>
              <td><a href="action\vendor\delete.php?id=' . $row['id_user'] . '" onclick="return ConfirmDelete()">Del</a></td>
              </tr>
              ';
